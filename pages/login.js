...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
      <SEO title="Sign in" description="Sign in to SellerOS. PDF crop, label crop and order sorting for Meesho, Flipkart, Amazon, Snapdeal sellers." canonicalPath="/login" />
