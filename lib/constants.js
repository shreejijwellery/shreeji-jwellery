...
export const ALL_PERMISSIONS = {
    ...
    IN_PROCESS_PRODUCT_CREATE: 'IN_PROCESS_PRODUCT_CREATE',
    IN_PROCESS_PRODUCT_UPDATE: 'IN_PROCESS_PRODUCT_UPDATE',
    IN_PROCESS_PRODUCT_DELETE: 'IN_PROCESS_PRODUCT_DELETE',
}

export const FINAL_PRODUCT_SECTION = 'Final Product'
export const checkPermission = (user, permission) => {
    return user?.role === USER_ROLES.ADMIN || user?.role === USER_ROLES.ADMINISTRATOR || user?.permissions?.includes(permission);
}
